...
This matrix stores pairwise chemical similarity among features (0–1, higher = more similar). Downstream functions convert to distance internally as needed. Once added, later analyses can distinguish between features that are unrelated and features that are distinct but still structurally similar.
