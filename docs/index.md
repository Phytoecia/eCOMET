...
— add layers, themes, and annotations after the call - Stacked bar
plots of NPC compound class composition by group - Heatmaps with
flexible normalization and annotation tracks

-----

![eCOMET workflow
overview](./images/workflows/ecomet_workflow_total.png)
