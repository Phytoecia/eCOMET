...
Unlike existing metabolomics toolkits that focus primarily on biomedical or cheminformatics applications, eCOMET is designed explicitly for ecological metabolomics (ecometabolomics). 
